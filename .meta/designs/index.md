...
| [configurable-review-dimensions.md](configurable-review-dimensions.md) | draft | 2026-07-03 | /review resolves its dimensions (config → context → ask); /retro calibrates agent choices into config; /review as proving ground for per-skill config |
