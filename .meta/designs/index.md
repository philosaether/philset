...
| [progressive-disclosure.md](progressive-disclosure.md) | draft | 2026-07-03 | Reveal complexity as the user is ready: `disclosure` level knob + plugin-floor/MCP-ladder; staged Phase 0 (`/hey`+`hello.check`) → Phase 3 (MCP updates) |
