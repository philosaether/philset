...
| [integrated-workflow-system.md](integrated-workflow-system.md) | accepted · Stage 1 building | 2026-07-01 | philset+Praxis as relations over one leaf-set; north star = workflow scaling; staged path, first move = calendar/CRM MCP hooks |
